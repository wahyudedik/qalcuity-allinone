        ...
        <div className="space-y-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder={t('inventory.products.skuPlaceholder') || 'Contoh: WDT-001'}
                        />
            ...
            <input
                ...
                onChange={(e) => {
                    ...
                    if (file) {
                        setToast({ message: `${t('common.success') || 'Berhasil'}: File "${file.name}" ${t('inventory.products.uploading') || 'Mengunggah...'}`, type: 'success' })
                    }
                }}
            />
