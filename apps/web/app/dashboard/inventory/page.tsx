...
const summaryCards = [
    { titleKey: 'inventory.overview.totalProducts', value: '248', icon: Package, color: 'text-blue-600', href: '/dashboard/inventory/products' },
    { titleKey: 'inventory.overview.availableStock', value: '12,450', icon: ClipboardList, color: 'text-green-600', href: '/dashboard/inventory/stock' },
    { titleKey: 'inventory.overview.lowStock', value: '18', icon: AlertTriangle, color: 'text-yellow-600', href: '/dashboard/inventory/stock' },
    { titleKey: 'inventory.overview.outOfStock', value: '5', icon: CircleOff, color: 'text-red-600', href: '/dashboard/inventory/stock' },
]
                        ...
                        {lowStockItems.map((item) => (
                            <div key={item.sku} className="flex items-center justify-between px-4 py-3">
                                ...
                                <div className="text-right">
                                    ...
                                    <button className="text-xs text-blue-600 hover:underline">{t('inventory.overview.reorder')}</button>
                                </div>
                            </div>
                        ))}
                    </div>
